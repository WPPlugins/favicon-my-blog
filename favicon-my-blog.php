<?php
/*
Plugin Name: Favicon My Blog
Plugin URI: http://rockemmusic.wordpress.com/2011/06/04/favicon-my-blog
Description: Allows you to display your own favicon on your website!
Version: 1.0.2
Author: Rockemmusic
Author URI: http://www.rockemmusic.com
*/

/*  Copyright 2011 Rockemmusic - support@rockemmusic.wordpress.com
...
add_action('admin_menu', 'favicon_my_blog_add_pages');

// action function for above hook
function favicon_my_blog_add_pages() {
    add_options_page('Favicon My Blog', 'Favicon My Blog', 'administrator', 'favicon_my_blog', 'favicon_my_blog_options_page');
}

// favicon_my_blog_options_page() displays the page content for the Test Options submenu
function favicon_my_blog_options_page() {
...
<?php
    ...
    echo "<h2>" . __( 'Favicon My Blog Plugin Options', 'mt_trans_domain' ) . "</h2>";
...
if ($customvar3=="") {
$customvar3="Enter URL to .png image here";
}
    ?>
<form name="form1" method="post" action="">
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">

<strong>It is recommended to use both the .ico file and .gif/.png file - Both the same file in different formats - for maximum compatibility with browsers!</strong>

<p><?php _e("URLs to Image Files:", 'mt_trans_domain' ); ?> 
<br />URL to 16x16 or 32x32 pixel .ico file: <input type="text" name="customurl" value="<?php echo $customvar; ?>" /><br /><br /><br />
URL to 16x16 or 32x32 pixel .gif file: <input type="text" name="customurl2" value="<?php echo $customvar2; ?>" /><br /> 
<strong>OR</strong></br />
URL to 16x16 or 32x32 pixel .png file: <input type="text" name="customurl3" value="<?php echo $customvar3; ?>" /><br /> 
</p><hr />

<p><?php _e("Show a link to support Favicon My Blog?", 'mt_trans_domain' ); ?> 
...
$customvar=get_option("mt_Favicon_custom");
$customvar2=get_option("mt_Favicon_custom2");
$customvar3=get_option("mt_Favicon_custom3");

?>
<?php if ($customvar!="" && $customvar!="Enter URL to .ico image here") { ?>
<link rel="shortcut icon" href="<?php echo $customvar; ?>" type="image/x-icon" />
<?php } ?>
<?php if ($customvar2!="" && $customvar2!="Enter URL to .gif image here") { ?>
<link rel="icon" href="<?php echo $customvar2; ?>" type="image/gif"    />
<?php } ?>
<?php if ($customvar3!="" && $customvar3!="Enter URL to .png image here") { ?>
<link rel="icon" href="<?php echo $customvar2; ?>" type="image/png"    />
<?php
}
}
...
function Favicon_footer_plugin_support() {
  $pshow = "<p style='font-size:x-small'>Favicon Plugin made by <a href='http://www.rockemmusic.com'>Alesis</a></p>";
  echo $pshow;
}
